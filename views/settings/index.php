...
<div class="admin-box">
    ...
    <fieldset>
        ...
        if (isset($sources_baseball) && is_array($sources_baseball) && count($sources_baseball)) :
			$selection = ( isset ($settings['stk.source_baseball']) ) ? (int) $settings['stk.source_baseball'] : 1;
		...
		if (isset($sources_football) && is_array($sources_football) && count($sources_football)) :
			$selection = ( isset ($settings['stk.source_football']) ) ? (int) $settings['stk.source_football'] : 1;
		...
		if (isset($sources_basketball) && is_array($sources_basketball) && count($sources_basketball)) :
			$selection = ( isset ($settings['stk.source_basketball']) ) ? (int) $settings['stk.source_basketball'] : 1;
